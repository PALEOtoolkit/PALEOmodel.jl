...
- `step_callbacks=[]`: vector of callback functions to follow a successful step `[step_callback(sol.zero, tss, deltat, model, modeldata)]`, 
...
- [Deprecated: `sol_min`: now has no effect, replace with 
  `solve_kwargs=(project_region! = PALEOmodel.SolverFunctions.ClampAll!(sol_min, sol_max), )`]
"""
